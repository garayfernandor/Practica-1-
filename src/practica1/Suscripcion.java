...
public abstract class Servicio implements Sujeto {
     ...
     */
    @Override public void notificaA(Observador observador)
                          throws IllegalArgumentException {
        if (observador == null || Cliente.class != observador.getClass())
            throw new IllegalArgumentException();
        @SuppressWarnings("unchecked") Cliente cliente = (Cliente)observador;
        cliente.getRecomendaciones().add(recomendacionDelDia);
        System.out.println("Hola " + cliente.getNombre() + "! de parte 
                            de " toString() " y con base en tus gustos
                            queremos recomendarte " + recomendacionDelDia)	
    }    
